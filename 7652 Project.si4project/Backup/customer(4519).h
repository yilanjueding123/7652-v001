...
#define DBG_MESSAGE 			CUSTOM_ON//CUSTOM_ON//CUSTOM_OFF//CUSTOM_ON	// UART debug message
...
#define FUN_KEY 				IO_D10// IO_B2
#define IRCTR_KEY				IO_F15//	 IO_B3

#define SCCB_SCL				IO_A3// Sensor I2C clock pin
#define SCCB_SDA				IO_A4// Sensor I2C data pin	
...
#define LED1					IO_E0//IO_E1
#define LED2					IO_E1//IO_E0
#define VIBRATOR				IO_C14

#define CHARGE_PIN				IO_C13

#define CDSP_IQ 				GPCV1248_JVIN_V1_0//GPCV1248_C6_V2_0	
#define PRODUCT_NUM 			7652
#define PRODUCT_DATA			20170619
...
#define AUD_RECORD_EN			CUSTOM_ON
